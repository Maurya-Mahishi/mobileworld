...
driver.findElement(By.xpath("//*[@placeholder='Username']")).sendKeys("maurya");
driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("maurya.tth@gmail.com");
